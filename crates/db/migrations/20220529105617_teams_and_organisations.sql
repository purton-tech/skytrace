...
GRANT SELECT, INSERT ON organisation_users TO trace_application;
GRANT SELECT, INSERT, UPDATE ON organisations TO trace_application;
GRANT SELECT, INSERT, DELETE ON invitations TO trace_application;
GRANT USAGE, SELECT ON invitations_id_seq, organisations_id_seq TO trace_application;

-- Give access to the readonly user
GRANT SELECT ON invitations, organisations, organisation_users TO trace_readonly;
GRANT SELECT ON invitations_id_seq, organisations_id_seq TO trace_readonly;
