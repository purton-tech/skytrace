...
CREATE TYPE confidentiality AS ENUM ('Confidential', 'Filtered', 'Public');

COMMENT ON TYPE confidentiality IS 'Restrict which data is viewable to other users'
  'Confidential: This data is not to be shared with other users.'
  'Filtered: The data is shareable with selected users.'
  'Public: Everyone is allowed to see this data.';
...
GRANT SELECT ON sessions, users TO trace_readonly;
