...
ARG APP_IMAGE_NAME=purtontech/trace-server:latest
ARG MIGRATIONS_IMAGE_NAME=purtontech/trace-db-migrations:latest
ARG ENVOY_IMAGE_NAME=purtontech/trace-envoy:latest
ARG FEED_IMAGE_NAME=purtontech/trace-space-track-feed:latest
